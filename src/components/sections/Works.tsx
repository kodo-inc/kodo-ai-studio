...
const works = [
  ...
  },
  {
    ...
    title: "新規事業のMVP高速検証",
    description:
      "アイデア段階のプロダクトを2〜4週間でMVP化し、市場の反応を高速検証。日本・グローバル両方の事業立ち上げ経験を活かしてサポート。",
    tags: ["MVP", "新規事業", "グローバル"],
  },
  {
    category: "C向けプロダクト",
    ...
    description:
      "複数のC向けAIアプリを企画から開発・運用まで一貫して担当。継続率・課金率を上げるためのプロダクト設計と改善サイクルを構築しています。",
    tags: ["C向け", "AIネイティブ", "継続率改善"],
  },
  {
    category: "マーケティング",
    title: "AIインフルエンサーのSNSマーケティング自動化",
    description:
      "AIキャラクターを起点としたTikTok・Instagramマーケティングの戦略設計、コンテンツ運用、アウトリーチ自動化システムを構築。",
    tags: ["TikTok", "Instagram", "自動化"],
  },
];
