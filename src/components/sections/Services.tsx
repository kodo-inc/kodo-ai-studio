...
const others = [
  ...
  },
  {
    ...
    title: "アプリ開発",
    body:
      "Webサービスやモバイルアプリの企画・開発・運営を行います。プロトタイプから本リリース、運用改善まで、スピードを保ちながら品質を担保します。",
  },
  {
    num: "05",
    title: "爆速ホームページ制作",
    body:
      "コーポレートサイト・LPなどを最短1週間で納品。デザイン・構成・コピーの設計からSEO基本対応まで一括で対応します。",
  },
  {
    num: "06",
    title: "マーケティング支援",
    body:
      "広告運用（Meta / Google / TikTok 等）とソーシャルメディア運用、コンテンツ制作・配信オペレーションまで、戦略設計から実行までをサポートします。",
  },
  {
    num: "07",
    title: "ゲーミフィケーションの企画・支援",
    body:
      "既存サービスへのゲーミフィケーション要素の導入から、新しいゲーミフィケーション企画まで対応します。ゲーム開発で培った継続率や収益性の向上を、あらゆる領域に応用します。",
  },
  {
    num: "08",
    title: "新規事業の高速検証",
