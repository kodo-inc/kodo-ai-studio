const faqs = [
  ...
  },
  {
    ...
    a:
      "可能です。大規模な消費者向けAIアプリ・ゲームの運営経験から、ユーザー行動分析、KPIダッシュボード設計、ABテスト基盤、プロダクト改善サイクルまで一貫してご支援します。「使われ続け、課金されるプロダクト」を作るための判断軸を提供します。",
  },
  {
  ...
  },
  {
    ...
    a:
      "技術提供だけのベンダーではなく、PM・新規事業・C向けプロダクト開発の実戦経験を持つメンバーが、事業課題から逆算してAI活用を組み立てます。「作って終わり」ではなく、現場で使われ続け、事業数字を動かすところまで責任を持つことが強みです。",
  },
  {
  ...
  },
  {
    ...
    a:
      "ご満足いただけなかった場合は、ご料金を全額返金いたします。あわせて、本実装には進まずそこで止める判断もご一緒し、検証で得た知見は次の意思決定の材料として活かしていただけます。",
  },
];
