const faqs = [
  ...
  {
    q: "他社の開発・ディレクションベンダーと比べた強みは何ですか？",
    a:
      "技術提供だけのベンダーではなく、大企業や成長スタートアップでPM・新規事業・プロダクト/ゲーム開発・マーケティングをリードしてきたリーダー人材が、事業課題から逆算して打ち手を組み立てます。「作って終わり」ではなく、現場で使われ続け、事業数字を動かすところまで責任を持つことが強みです。",
  },
  {
    q: "個人情報や機密情報を扱うシステムも作れますか？",
    a:
      "可能です。OpenAI / Anthropic / Google などの法人向けプラン、Azure OpenAI、社内ネットワーク内で動くオープンソースモデルや、AIを使わない通常システムなど、扱う情報の機密度・要件に合わせて構成を選定します。",
  },
  {
    q: "今使っているSaaSと連携できますか？",
    a:
      "ほとんどのSaaSはAPI連携が可能です。すでに使っているサービスを置き換えるのではなく、必要な機能を足す形で導入できるよう設計します。",
  },
  {
    q: "開発したシステムの所有権はどうなりますか？",
    a:
  ...
  },
  {
    ...
    a:
      "可能です。自社で作ったサービス・アプリ・社内ツールについて、セキュリティレビューや運用体制の構築だけのご相談もお受けしています。",
  },
  {
